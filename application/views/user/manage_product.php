		...
		<td><input type="text" class="form-control form-control-sm" id="inputName2" placeholder="Search"></td>
											 ...
											 <table class="table table-bordered text-nowrap border-bottom" id="modalDataTable">
												...
												<tbody>
													...
													<a title="Product Specification"href="<?=BASE_URL();?>manage_specification"><i class="fas fa-plus-circle text-success ms-3"></i></a>
													<a title="Edit"href="<?=BASE_URL();?>edit_product"><i class="fa fa-lock ms-3"></i></a>
