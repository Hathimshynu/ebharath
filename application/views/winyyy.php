            ...
            <div class="col-md-12 avl-bl">
                <div class="row color">
                    <div class="col-xs-10" style="padding: 20px;">
                        <h3 style="color: #fff; font-size: 20px; margin-left:5px; margin-top:5px;">Available balance: ₹<span><?=$this->db->select('sum(credit)-sum(debit) as balance')->where('user_id',$this->session->userdata('bhpusername'))->get("wallet")->row()->balance+0;?></span></h3>
        ...
        <div class="tab">
            ...
            <!--<button class="tablinks" data-value="4" onclick="opentab(event, 'Emerd')"   >Emerd</button>-->
                ...
                <div id="gameDiv">
                    ...
                    <div class="row">
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="0" data-target=".myModalParity" aria-hidden="true">0</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="1" data-target=".myModalParity" aria-hidden="true">1</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="2" data-target=".myModalParity" aria-hidden="true">2</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="3" data-target=".myModalParity" aria-hidden="true">3</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="4" data-target=".myModalParity" aria-hidden="true">4</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="5" data-target=".myModalParity" aria-hidden="true">5</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="6" data-target=".myModalParity" aria-hidden="true">6</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="7" data-target=".myModalParity" aria-hidden="true">7</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="8" data-target=".myModalParity" aria-hidden="true">8</button></div>
                        <div class="col btn-num game-val"><button class="parity_chose" data-toggle="modal"  data-value="9" data-target=".myModalParity" aria-hidden="true">9</button></div>
                    </div>
                </div>
...
<?php } ?>  
                ...
                <div id="gameDiv">
                    ...
                    <div class="row">
                        <div class="col btn-num game-val"><button data-toggle="modal" class="game-val game-val0" data-value="0" data-target=".myModal" aria-hidden="true">0</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="1" data-target=".myModal" aria-hidden="true">1</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="2" data-target=".myModal" aria-hidden="true">2</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="3" data-target=".myModal" aria-hidden="true">3</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="4" data-target=".myModal" aria-hidden="true">4</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="5" data-target=".myModal" aria-hidden="true">5</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="6" data-target=".myModal" aria-hidden="true">6</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="7" data-target=".myModal" aria-hidden="true">7</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="8" data-target=".myModal" aria-hidden="true">8</button></div>
                        <div class="col btn-num game-val"><button data-toggle="modal"  data-value="9" data-target=".myModal" aria-hidden="true">9</button></div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-center" role="document" style="max-width: 500px;">
        <div class="modal-content" style="border-radius: 0;">
            ...
            <form method="post" action="<?=BASEURL?>user/join_game">
                ...
                <input type="hidden" id="game_Type" name="game_Type" value="Parity">
...
<script>
    $(document).ready(function () {
        ...
        $('.parity_chose').on('click', function () {
